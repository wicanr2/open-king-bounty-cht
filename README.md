...
1990 年的策略 RPG 始祖《King's Bounty》,現在全程繁體中文,在 **Windows / macOS / Linux** 上免費就能玩。招一支從農夫、弓兵到巨龍的雜牌大軍,橫越四塊大陸把惡棍一個個揪出來,趕在天數耗盡前奪回失落的王權。

- ⚔️ **全文繁體中文** —— 兵種、法術、城堡的譯名照當年官方手冊,是記憶裡那個味道
...
想做類似老遊戲漢化／跨平台移植的人,過程中的工程教訓(多版本資產破解、CJK 低解析渲染、跨平台打包陷阱、Android 觸控移植)彙整於 [`docs/LESSONS.md`](docs/LESSONS.md)。
...
- **原作**:Jon Van Caneghem 設計,New World Computing 發行(King's Bounty, 1990)。逆向原版執行檔時,還發現開發者把自己畫成了遊戲裡的反派——這個藏了三十多年的彩蛋,見 [**反派通緝名單其實是開發團隊**](docs/easter-eggs.md)。
